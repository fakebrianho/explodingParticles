...
void main()	{
	...
	vec4 tex3 = texture2D(t3, vUv);
	// vec4 tex4 = texture2D(t4, vUv);
	vec4 finalTexture = mix(tex, tex2, progress);
	finalTexture = mix(finalTexture, tex3, progress2);
	// finalTexture = mix(finalTexture, tex4, progress3);
